...
def upgrade():
    ...
    op.create_table(
        "exercise_instance_entry_service",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("instance_id", sa.Integer(), nullable=False),
        sa.Column("container_id", sa.Text(), nullable=True),
        sa.ForeignKeyConstraint(
            ["instance_id"], ["exercise_instance.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("container_id", sa.Text(), nullable=True),
        sa.ForeignKeyConstraint(
            ["exercise_service_id"], ["exercise_service.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["instance_id"], ["exercise_instance.id"], ondelete="RESTRICT"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["origin_instance_id"], ["exercise_instance.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["submitted_instance_id"], ["exercise_instance.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )

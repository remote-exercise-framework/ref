...
class GeneralSettings(Form):
    regestration_enabled = BooleanField("Allow users to register.")
...
def view_system_settings():
    ...
    # General settings
    general_settings_form = GeneralSettings(
        request.form, prefix="general_settings_form"
    )
    general_settings_mapping = [
        (
            SystemSettingsManager.REGESTRATION_ENABLED,
            general_settings_form.regestration_enabled,
        ),
        (SystemSettingsManager.COURSE_NAME, general_settings_form.course_name),
        (
            SystemSettingsManager.SUBMISSION_ALLOW_DELETE,
            general_settings_form.allow_submission_deletion,
        ),
        (
            SystemSettingsManager.SUBMISSION_DISABLED,
            general_settings_form.disable_submission,
        ),
        (
            SystemSettingsManager.SUBMISSION_HIDE_ONGOING,
            general_settings_form.hide_ongoing_exercises_for_grading_assistant,
        ),
        (SystemSettingsManager.TIMEZONE, general_settings_form.timezone),
        (
            SystemSettingsManager.MAINTENANCE_ENABLED,
            general_settings_form.maintenance_enabled,
        ),
        (
            SystemSettingsManager.TELEGRAM_LOGGER_TOKEN,
            general_settings_form.telegram_logger_token,
        ),
        (
    ...
    ssh_settings_mapping = [
        ...
        (
            SystemSettingsManager.INSTANCE_SSH_INTROSPECTION,
            ssh_settings_form.ssh_instance_introspection,
        ),
        (
            SystemSettingsManager.INSTANCE_NON_DEFAULT_PROVISIONING,
            ssh_settings_form.allow_none_default_provisioning,
        ),
        (
            SystemSettingsManager.ALLOW_TCP_PORT_FORWARDING,
            ssh_settings_form.ssh_allow_tcp_forwarding,
        ),
        (
            SystemSettingsManager.ALLOW_ROOT_LOGINS_FOR_ADMINS,
            ssh_settings_form.ssh_allow_root_logins_for_admin,
        ),
        (
            SystemSettingsManager.SSH_MESSAGE_OF_THE_DAY,

...
class TestAdminExerciseEndpoints:
    ...
    def test_build_nonexistent_exercise(self, admin_session: httpx.Client) -> None:
        ...
        # 200 = error page rendered, 302 = redirect with flash, 400 = invalid, 404 = not found
        # Multiple codes valid because error handling can occur at different layers
    ...
    def test_exercise_id_injection(self, admin_session: httpx.Client) -> None:
        ...
        for injection_id in injection_ids:
            ...
            # Security test: verify no 500 crash. Code depends on where validation fails:
            # 200 = page with error, 400 = invalid input, 404 = route/resource not found
...
class TestAdminVisualizationEndpoints:
    ...
    def test_containers_graph_unauthenticated(self, raw_client: httpx.Client) -> None:
        ...
        # 302 = redirect to login, 404 = endpoint doesn't exist
